...
# to reduces  word embeddings  dimensionality to 2D using t-SNE
...
# Perplexity is commonly used in natural language processing tasks, such as machine translation, speech recognition, and language generation.
