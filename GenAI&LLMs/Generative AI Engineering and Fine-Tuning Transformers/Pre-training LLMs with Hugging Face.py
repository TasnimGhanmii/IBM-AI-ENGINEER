...
""" the tokenizer wants to use several helpers (threads) at once.
If my PyTorch dataloader is already using its own helpers (extra worker processes), the two groups bump into each other and the library shouts “I might deadlock!”
os.environ['TOKENIZERS_PARALLELISM'] = 'false'
is just telling the tokenizer: “stay single-threaded so we don’t fight,” and the warning disappears."""
